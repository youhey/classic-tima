...
/* EUC-JP限定：全角空白と「ー」を含むひらがなのマルチバイト正規表現 */
define('VALIDATE_MB_HIRAGANA_EUC', "(?:[\xA4\xA1-\xA4\xF3]|\xA1\xBC|\xA1\xA1)");

/**
 * 文字列がひらがなのみで構成されているかを検証
 * 
 * @package    tima
 * @subpackage tima_Validator
 * @version    SVN: $Id: Hiragana.class.php 6 2007-08-17 08:46:57Z do_ikare $
 */
class Validator_Hiragana extends Validator_AbstractValidator
{
